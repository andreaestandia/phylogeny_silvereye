...
Sample_List=/data/zool-zost/Novogene/EstimateGLs_phylogeny/resources/raw_reads
...
# We will use FastP - a tool designed to provide fast all-in-one preprocessing for
 FastQ files
